export const data: any = {
    ...
    빅데이터분석기업: {
        ...
        title: "빅데이터 분석 기업: (주)더아이엠씨",
        cover: '/images/logo_theimc.png',
        contents: `

- 회사명: 주식회사 더아이엠씨(영어 : The IMC Inc.)

- 홈페이지: https://theimc.co.kr

- 회사소개
    - 대한민국의 IT 기업. 2003년 12월 통합적마케팅커뮤니케이션 기업으로 출발

    - 2012년 데이터사이언스연구소를 설립, 텍스톰, 텍스토미 등을 개발하면서 빅데이터·AI 사업으로 그 영역을 확장

    - 국방기술품질원, 대구시, 현대자동차 등 국내 공공기관 및 기업의 빅데이터 활용 사업을 수주

    - 텍스트마이닝 솔루션인 텍스톰과 AI 기반 마케팅 지원 솔루션 텍스토미 등 다양한 빅데이터 활용 서비스를 제공하고 있음  
